...
public class Recruiter {
	...
	public Recruiter(Long id, String companyName, Double salary, String jobDesignation, String jobDescription,
			String location, String eligibility, Integer totalRequirement) {
		this.id = id;
	...
	public String toString() {
		return "Recruiter{" + "id=" + id + ", companyName='" + companyName + '\'' + ", salary=" + salary
				+ ", jobDesignation='" + jobDesignation + '\'' + ", jobDescription='" + jobDescription + '\''
				+ ", location='" + location + '\'' + ", eligibility='" + eligibility + '\'' + ", totalRequirement='"
				+ totalRequirement + '\'' + '}';
	}
}
